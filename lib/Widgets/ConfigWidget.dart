...
class _ConfigWidgetState extends State<ConfigWidget> {
  ...
  final GlobalKey<FormFieldState<dynamic>> dropdownKeyAdhan = GlobalKey<FormFieldState<dynamic>>();


  String? tafsirId;
  String? tajweedAyahId;
  String? tajweedSurahId;
  String? adhanAuteurId;
  ...
  TextEditingController searchContentAdhan = TextEditingController();
  ...
  List<Map<String,dynamic>> adhanList = [
    {
      "auteur" : "Ibrahim Al Arkani",
      "value" : "ibrahim_al_arkani"
    },
    {
      "auteur" : "Majid Al Hamthany",
      "value" : "majid_al_hamthany"
    },
    {
      "auteur" : "Mishary Alafasi",
      "value" : "mishary_alafasi"
    },
    {
      "auteur" : "Mohamed Tarek",
      "value" : "mohamed_tarek"
    },
    {
      "auteur" : "Nasser Alqatami",
      "value" : "nasser_alqatami"
    },
    {
      "auteur" : "Rabeh Ibn Darah Al Jazairi",
      "value" : "rabeh_ibn_darah_al_jazairi"
    },
    {
      "auteur" : "Omar Hisham Al Arabi",
      "value" : "omar_hisham_al_arabi"
    },
    {
      "auteur" : "Ali Burak",
      "value" : "tounsi_ali_burak"
    },
  ];
  ...
  void initState() {
    ...
    adhanAuteurId = box.get("adhanAuteurId");
  }
                    ...
                    children: [
                      Expanded(
                        child: GestureDetector(
                          onTap: () async{
                            await Navigator.push(context, MaterialPageRoute(builder: (context) => AdhanConfiguration(adhanList : adhanList)));
                          },
                          child: AnimatedContainer(
